      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            Somos UNI MotorSports, te invitamos a ser parte de nuestro recorrido en la construcción del primer vehículo eléctrico tipo fórmula de la Universidad Nacional de Ingeniería que participará en la competición <a class="fsae-michigan-link" href="https://www.sae.org/attend/student-events/formula-sae-michigan">FSAE Michigan</a>.
            </p>
